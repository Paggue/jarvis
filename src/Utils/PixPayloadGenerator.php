...
class PixPayloadGenerator
{
    ...
    /**
     * IDs do Payload do PixPayloadGenerator
     * @var string
     */
    ...
    /**
     * Responsável por retornar o valor completo de um objeto do payload PixPayloadGenerator
     *
     * @param string $id
     * @param string $value
